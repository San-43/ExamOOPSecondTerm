...
public class Veterinarian implements Serializable {
    ...
    public Veterinarian(int x) {
        ...
        do {
            try {
                ...
                if (Period.between(dateOfBirth, dateOfHire).getYears() < 20 || Period.between(dateOfBirth, dateOfHire).getYears() > 80) {
    ...
    public void serialize(@NotNull ArrayList<Veterinarian> list) {
        try {
